<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AddCity.aspx.cs" Inherits="JobApplication.AddCity" %>
                    ...
                    <div>
                        Add City
                                        <div class="page-title-subheading">
                                            Add City for drop down selection
                                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtcity" AutoComplete="off" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
